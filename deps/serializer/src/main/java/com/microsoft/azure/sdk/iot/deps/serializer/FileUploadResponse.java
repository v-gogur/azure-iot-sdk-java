...
public class FileUploadResponse
{
    ...
    {
        /* Codes_SRS_FILE_UPLOAD_RESPONSE_21_001: [The constructor shall create an instance of the FileUploadResponse.] */
        ...
        try
        {
            newFileUploadResponse = gson.fromJson(json, FileUploadResponse.class);
        }
        ...
        Utility.validateStringUTF8(newFileUploadResponse.hostName);
        Utility.validateStringUTF8(newFileUploadResponse.containerName);
        Utility.validateStringUTF8(newFileUploadResponse.correlationId);
        Utility.validateStringUTF8(newFileUploadResponse.blobName);
        Utility.validateStringUTF8(newFileUploadResponse.sasToken);
        ...
        this.hostName = newFileUploadResponse.hostName;
        this.containerName = newFileUploadResponse.containerName;
        this.correlationId = newFileUploadResponse.correlationId;
        this.blobName = newFileUploadResponse.blobName;
        this.sasToken = newFileUploadResponse.sasToken;
    }
